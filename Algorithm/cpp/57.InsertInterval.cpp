 ...
 * Example 2:
 * Given intervals [1,2],[3,5],[6,7],[8,10],[12,16],insert and merge [4,9] in as [1,2],[3,10],[12,16].
...
public:
    ...
    vector<Interval>merge(vector<Interval>&intervals)
    {
        ...
        for (int i = 0; i < intervals.size(); i++)
        {
            ...
            /* if the current intervals[i] is overlap with provious interval. */
            /* merge them together */
...
int main()
{
    ...
    Interval n(4, 9);
    vector<Interval> r = s.insert(intervals, n);
